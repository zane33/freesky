                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                            rx.button(
                                ...
                                on_click=rx.redirect(f"http://{config.host_ip}:{config.frontend_port}/playlist.m3u8", is_external=True),
                                size="3",
                            ),
                            rx.button(
                                "Copy Link",
                                ...
                                on_click=[
                                    rx.set_clipboard(f"http://{config.host_ip}:{config.frontend_port}/playlist.m3u8"),
                        ...
                        rx.box(
                            rx.text(
                                f"http://{config.host_ip}:{config.frontend_port}/playlist.m3u8",
                                font_family="mono",
                                font_size="sm",
                            ),
                            padding="0.75rem",  
